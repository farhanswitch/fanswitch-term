    ...
    <div className="flex flex-col gap-1.5 py-1">
      {SOCIAL_LINKS.map((link, i) => (
        ...
        >
          ...
          <span className="text-zinc-500 group-hover:text-emerald-400/60 shrink-0 w-24 sm:w-28">
            {link.label}
          </span>
          <span className="text-zinc-600 group-hover:text-zinc-500 transition-colors select-none shrink-0 hidden sm:inline">
            →
          </span>
          <span className="text-emerald-400/70 group-hover:text-emerald-300 transition-colors truncate underline underline-offset-2 decoration-emerald-400/20 group-hover:decoration-emerald-400/50">
